...
echo "   bash submit_final_runs.sh                      # rloo4, all rungs A→D"
echo "   VARIANT=rloo8 bash submit_final_runs.sh        # rloo8 variant"
echo "   VARIANT=rloo4 START_RUNG=${RUNG} bash submit_final_runs.sh  # this rung only"
echo ""
